...
import { ProcessedResult, CategoryName, Quote } from "../types";
...
const processImages = async (
  ...
  const prompt = `
    ...
    2. Classify the overall theme into EXACTLY ONE of these categories: 'Flirty', 'Motivation', 'Relationships', 'Confidence', 'Mindset'. If none fit perfectly, pick the closest one.
